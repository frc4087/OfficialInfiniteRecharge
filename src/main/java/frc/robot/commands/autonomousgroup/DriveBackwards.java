...
public class DriveBackwards extends CommandBase {
 ...
 public void execute() {  
  ...
  if(robot.m_drivebase.left_ff.getEncoder().getPosition() > distance){
    robot.m_drivebase.left_side.set(-0.25);
    robot.m_drivebase.right_side.set(-0.25);
   }else{
    robot.m_drivebase.left_side.set(0);
    robot.m_drivebase.right_side.set(0);
  }
