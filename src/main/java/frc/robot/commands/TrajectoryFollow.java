...
public class TrajectoryFollow extends CommandBase {
  ...
  public TrajectoryFollow() {
    ...
    addRequirements(Robot.m_robotContainer.m_drivebaseAuto);
  }
  ...
  public Command getAutonomousCommand() {
   ...
   /* Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
    ...
    RamseteCommand ramseteCommand = new RamseteCommand(exampleTrajectory,
        Robot.m_robotContainer.m_drivebaseAuto.getPose(),
        new RamseteController(Constants.kRamseteB, Constants.kRamseteZeta),
        new SimpleMotorFeedforward(Constants.ksVolts,
                                   Constants.kvVoltSecondsPerMeter,
                                   Constants.kaVoltSecondsSquaredPerMeter),
        Constants.m_driveKinematics,
        Robot.m_robotContainer.m_drivebaseAuto.getWheelSpeeds(),
        new PIDController(Constants.kPDriveVel, 0, 0),
        new PIDController(Constants.kPDriveVel, 0, 0),
        // RamseteCommand passes volts to the callback
        Robot.m_robotContainer.m_drivebaseAuto.voltageControl(ControlMode.PercentOutput, 10.0, 10.0);,
        Robot.m_robotContainer.m_drivebaseAuto);
